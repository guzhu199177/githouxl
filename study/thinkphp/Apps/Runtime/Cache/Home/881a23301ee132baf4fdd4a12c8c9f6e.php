...
<link rel="stylesheet" href="/study/thinkphp/css/pager.css"/>
 ...
 <title>学生课程表</title>
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <title></title>
    <link href="/study/thinkphp/css/bootstrap.css" rel="stylesheet">
    <style>
        #main-nav {
            margin-left: 1px;
        }
    ...
    <style type="text/css">
.kuan input{ width:200px; height:30px ;position:relative;left:688px;boder:solid 1px #f00;}
.an input{ width:200px; height:30px;position:relative;left:400px; boder:solid 1px #f00;}
</style>
       <div class="top-nav">
           <div class="tn-bg">
               <div class="tn-header">
 ...
 <div class="navbar navbar-duomi navbar-static-top" role="navigation" height="30px">
    ...
    <div class="container-fluid">
                ...
                <ul id="main-nav" class="nav nav-tabs nav-stacked" style="">
                    ...
                    <li>
                        ...
                        <ul id="systemSetting" class="nav nav-list collapse secondmenu" style="height: 0px;">
                            ...
                            <li><a href="/study/thinkphp/index.php/home/student"><i class="glyphicon glyphicon-asterisk"></i>学生信息管理</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="./plans.html">
		...
		<table id="sample-table-2" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample-table-2_info">
			<thead><!--  xx start{{{ -->
				...
				<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Price: activate to sort column ascending" style="width: 117px;">年龄</th>
				<th class="hidden-480 sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Clicks: activate to sort column ascending" style="width: 125px;">性别</th>
				<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Update: activate to sort column ascending" style="width: 189px;">班级</th>
			...
			<tbody role="alert" aria-live="polite" aria-relevant="all"><tr class="odd">
				 ...
				 <form action="/study/thinkphp/index.php/home/student/add" method="post">
			    ...
			    <form action="/study/thinkphp/index.php/home/student/sel" method="post">
						<input type="text" class="aa" name="search" placeholder="请输入学生学号或姓名"/>
				...
				<form method="post">
					<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
						...
						<td><a href="/study/thinkphp/index.php/home/student/delete?id=<?php echo ($vo["id"]); ?>">删除</a>
		  					<a href="/study/thinkphp/index.php/home/student/update?id=<?php echo ($vo["id"]); ?>">修改</a></td>

    ...
    <div class="container-fluid">
		...
		<table id="sample-table-2" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample-table-2_info">
			<thead><!--  xx start{{{ -->
				...
				<?php if(is_array($course_data)): foreach($course_data as $key=>$v): ?><th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" aria-label="Price: activate to sort column ascending" style="width: 117px;">
			...
			<tbody role="alert" aria-live="polite" aria-relevant="all"><tr class="odd">
				 ...
				 <form action="/study/thinkphp/index.php/home/test/add" method="post">
			    ...
			    <form action="/study/thinkphp/index.php/home/test/sel" method="post">
						<input type="text" class="aa" name="search" placeholder="请输入学生学号或姓名"/>
						<input type="submit" value="search" />
				</form>
				</div>
				<form method="post">
					<?php if(is_array($data)): foreach($data as $key=>$vo): if(is_array($course_data)): foreach($course_data as $key=>$value): ?><tr>
						<td><?php echo ($vo["stu_id"]); ?></td>
						<td><?php echo ($vo["stu_name"]); ?></td>
						<td><?php echo ($vo["value"]["yuwen"]); ?></td>
						<td><?php echo ($vo["value"]["shuxue"]); ?></td>
						<td><?php echo ($vo["value"]["english"]); ?></td>
						<td><?php echo ($vo["value"]["english"]); ?></td>
						<td><?php echo ($vo["value"]["english"]); ?></td>
